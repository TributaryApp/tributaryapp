      ...
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6">
            This is the project information will be displayed publicly
          </p>
          <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                <textarea
                  ...
                  name="about"
                  rows={3}
                  className="block w-full rounded-md border-0 py-1.5 bg-transparent shadow-sm ring-1 ring-inset ring-gray-300 placeholder focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  defaultValue={''}
                />
              </div>
              <p className="mt-3 text-sm leading-6">Write a few sentences about the project.</p>
            </div>
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                ...
                <button
                  type="button"
                  className="rounded-md px-2.5 py-1.5 text-sm font-semibold shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 hover:text-black"
                >
                  Change
                </button>
              </div>
